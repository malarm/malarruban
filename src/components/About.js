    ...
    <section className="about-me">
      ...
      <article className="description">
        ...
        <p>
          ...
          that I fight back and keep moving, no matter how hard I get hit. As a
          woman, mother to two young children and an expat from India to
          Denmark, my life has demanded a lot of flexibilities and sacrifices in
          my career.
        </p>
        <br />
        <p>
